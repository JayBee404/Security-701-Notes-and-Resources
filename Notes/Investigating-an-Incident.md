Security Information and Event Monitoring (SIEM) - Combination of different data sources into onw tool that provides real-time analysis of security alerts generated by applicaitons and network hardware  
